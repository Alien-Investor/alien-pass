...
- **Auto-Lock**: nach Inaktivität (1–15 min oder aus) und im Hintergrund (sofort / 30 s / 1 min / 5 min). Bei „sofort“ sperrt die Android-App auch,
  während der Datei-Picker offen ist (am Desktop nicht); die gewählte Datei geht nicht verloren, nach dem Entsperren läuft der Import weiter
  (bei `.vault` und PGP-Export mit der Passphrase-Abfrage).
